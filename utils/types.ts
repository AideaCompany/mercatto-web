export type Producto = {_id:string,nombre:string,descripcion:string,precio:number,imagenes:{url:string},descuento?:number,precioDescuento?:number,peso?:string, sub_categoria?:string}
